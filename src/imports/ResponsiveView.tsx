import svgPaths from "./svg-oat1qf7dzn";
...
function Frame8() {
  return (
    <div className="absolute h-[548px] left-[119px] top-[184px] w-[1156px]">
      <Frame />
      <Frame1 />
      <Frame2 />
      <Frame3 />
...
function Header() {
  return (
    <div className="absolute border-[0px_0px_0.5px] border-[rgba(255,255,255,0.2)] border-solid h-[64px] left-[48px] right-[48px] top-0" data-name="Header">
      <Content />
    </div>
  );
}
...
function LedScreen() {
  return (
    <div className="absolute h-[48px] left-[calc(50%+375px)] rounded-[3px] top-[calc(50%-392px)] translate-x-[-50%] translate-y-[-50%] w-[360px]" data-name="LED screen" style={{ backgroundImage: "linear-gradient(26.1779deg, rgb(228, 232, 237) 42.645%, rgb(226, 234, 237) 82.759%)" }}>
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Content1 />
      </div>
...
function Row() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[48px] items-center left-[274px] top-[96px]" data-name="Row">
      <PlayButton />
      <RandomButton />
      <ClearButton />
      <SaveButton />
...
function Row1() {
  return <div className="absolute h-[32px] left-[771px] top-[145px] w-[360px]" data-name="Row" />;
}
...
function One() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative rounded-[6px] shrink-0" data-name="One" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 181.67 32\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'0.6000000238418579\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(9.0833 8.5865e-8 -1.2458e-8 2.1494 90.833 16)\\'><stop stop-color=\\'rgba(170,119,253,1)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(170,119,253,0)\\' offset=\\'1\\'/></radialGradient></defs></svg>'), linear-gradient(10.6745deg, rgb(138, 5, 255) 30.08%, rgb(72, 0, 140) 101.13%)" }}>
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-[48px] py-[7px] relative size-full">
          <Component />
        </div>
      </div>
...
function Component1() {
  return (
    <div className="absolute left-[calc(50%+1px)] overflow-clip size-[18px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="2">
      <div className="absolute bg-white left-[8.25px] size-[1.5px] top-[5.25px]" />
...
function Two() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative rounded-[6px] shrink-0" data-name="Two" style={{ backgroundImage: "linear-gradient(33.0009deg, rgba(163, 163, 157, 0.12) 42.645%, rgba(160, 160, 160, 0.12) 82.759%)" }}>
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Component1 />
      </div>
...
function Component2() {
  return (
    <div className="absolute left-[calc(50%+1.33px)] overflow-clip size-[18px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="3">
      <div className="absolute bg-white left-[8.25px] size-[1.5px] top-[5.25px]" />
      <div className="absolute bg-white left-[9.75px] size-[1.5px] top-[5.25px]" />
      <div className="absolute bg-white left-[11.25px] size-[1.5px] top-[6.75px]" />
      <div className="absolute bg-white left-[9.75px] size-[1.5px] top-[8.25px]" />
...
function Three() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative rounded-[6px] shrink-0" data-name="Three" style={{ backgroundImage: "linear-gradient(33.0009deg, rgba(163, 163, 157, 0.12) 42.645%, rgba(160, 160, 160, 0.12) 82.759%)" }}>
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Component2 />
      </div>
      <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_2px_8px_2px_rgba(0,0,0,0.16)]" />
...
function Phrase() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[273px] top-[772px] w-[561px]" data-name="Phrase">
...
function Frame25() {
  return (
    <div className="absolute content-stretch flex gap-[32px] items-start left-[270px] top-[859px] w-[564px]">
      <Filter />
      <Frame24 />
    </div>
  );
...
function Frame14() {
  return <div className="[grid-area:1_/_1] bg-gradient-to-b border-[1.125px] border-[rgba(255,255,255,0.2)] border-solid from-[#ffffff] h-[18px] ml-[152.07px] mt-0 rounded-[4.5px] to-[#aaaaaa] w-[19.552px]" />;
}

function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full">
      <div className="[grid-area:1_/_1] bg-[rgba(255,255,255,0.4)] border border-[rgba(255,255,255,0.2)] border-solid h-[4px] ml-0 mt-[7px] rounded-[4px] w-[378px]" />
      <Frame14 />
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="flex flex-col font-['PP Neue Montreal Mono',sans-serif] font-medium justify-end leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.66)] text-nowrap text-right tracking-[0.24px] uppercase">
        <p className="leading-[1.25]">DELAY TYPE</p>
      </div>
      <Frame15 />
    </div>
  );
...
function Effects() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[897px] top-[772px] w-[378px]" data-name="Effects">
      <Reverb />
      <DelayType />
      <DelayAmount />
    </div>
...
export default function ResponsiveView() {
  return (
    <div className="relative size-full" data-name="Responsive view" style={{ backgroundImage: "linear-gradient(161.271deg, rgb(13, 13, 13) 10.076%, rgb(25, 25, 25) 77.752%)" }}>
      <Frame8 />
      <Header />
      <LedScreen />
      <Row />
